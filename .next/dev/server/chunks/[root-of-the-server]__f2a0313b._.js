...
async function POST(req) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handle"])(async ()=>{
        ...
        const type = [
            ...
            'COMPETITION',
            'TIP'
        ].includes(body?.type) ? body.type : 'NEWS';
        const startsAt = body?.startsAt ? new Date(body.startsAt) : null;
        if (!title || title.length < 3) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('عنوان الحدث مطلوب (3 أحرف على الأقل)', 422);
        if (!text || text.length < 5) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('تفاصيل الحدث مطلوبة (5 أحرف على الأقل)', 422);
        if (startsAt && isNaN(startsAt.getTime())) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fail"])('تاريخ الحدث غير صحيح', 422);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f2a0313b._.js.map