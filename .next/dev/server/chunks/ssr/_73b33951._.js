...
const metadata = {
    ...
    description: "منصة سعودية متكاملة للتدريب على اختبار القدرات العامة (قياس): بنك أسئلة ضخم، اختبارات محاكاة، تحليل أداء، نقاشات تعليمية، ومساعد ذكي.",
    keywords: [
        "قدرات",
        "قياس",
        "GAT",
...
//# sourceMappingURL=_73b33951._.js.map