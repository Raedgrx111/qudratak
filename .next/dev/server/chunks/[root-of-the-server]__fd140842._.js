...
async function GET(req) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handle"])(async ()=>{
        ...
        const answerStats = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].$queryRawUnsafe(`SELECT userId, COUNT(*) as total, SUM(CASE WHEN isCorrect = 1 THEN 1 ELSE 0 END) as correct
       FROM AnswerRecord GROUP BY userId`);
        const statsMap = new Map(answerStats.map((s)=>[
                s.userId,
                {
        ...
        const examStats = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].$queryRawUnsafe(`SELECT userId, COUNT(*) as exams, AVG(score) as avgScore
       FROM ExamAttempt WHERE status = 'COMPLETED' GROUP BY userId`);
        const examMap = new Map(examStats.map((s)=>[
                s.userId,
                {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fd140842._.js.map